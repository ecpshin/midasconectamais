            ...
            <ul class="nav nav-child-indent nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link">
                        ...
                        <p class="font-semibold text-slate-5    0 hover:text-yellow-400">
                            Clientes
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.clientes.create') }}" class="nav-link">
                                ...
                                <p class="font-semibold text-slate-5    0 hover:text-yellow-400">Cadastrar</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.clientes.index') }}" class="nav-link">
                                <i class="fas fa-user nav-icon text-slate-100"></i>
                                <p class="font-semibold text-slate-5    0 hover:text-yellow-400">Lista de Clientes</p>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.propostas.index') }}" class="nav-link">
                                ...
                                <p class="font-semibold text-slate-5    0 hover:text-yellow-400">Lista de Propostas</p>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.propostas.filtrar') }}" class="nav-link">
                                ...
                                <p class="font-semibold text-slate-5    0 hover:text-yellow-400">Resumo</p>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.propostas.index') }}" class="nav-link">
                                ...
                                <p class="font-semibold text-slate-5    0 hover:text-yellow-400">Relatório Mensal</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.comissoes.operadores') }}" class="nav-link">
                                <i class="fas fa-hand-holding-usd nav-icon text-slate-100"></i>
                                <p class="font-semibold text-slate-5    0 hover:text-yellow-400">Comissões Agente</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.comissoes.corretores') }}" class="nav-link">
                                <i class="fas fa-hand-holding-usd nav-icon text-slate-100"></i>
                                <p class="font-semibold text-slate-5    0 hover:text-yellow-400">Comissões Corretor</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.comissoes.index') }}" class="nav-link">
                                <i class="fas fa-hand-holding-usd nav-icon text-slate-100"></i>
                                <p class="font-semibold text-slate-5    0 hover:text-yellow-400">Geral</p>
                            </a>
                        </li>
                        {{-- <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.tabelas.index') }}" class="nav-link">
                                ...
                                <p class="font-semibold text-slate-5    0 hover:text-yellow-400">Tabelas</p>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.agentes.create') }}" class="nav-link">
                                ...
                                <p class="font-semibold text-slate-5    0 hover:text-yellow-400">Novo Usuário</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.agentes.index') }}" class="nav-link">
                                <i class="fas fa-users nav-icon text-slate-100"></i>
                                <p class="font-semibold text-slate-5    0 hover:text-yellow-400">Usários Registrados</p>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="nav nav-treeview">
                        @hasrole('super-admin')
                            <li class="nav-item">
                                <a href="{{ route('admin.calls.gerenciar') }}" class="nav-link">
                                    ...
                                    <p class="font-semibold text-slate-5    0 hover:text-yellow-400">Gerenciar</p>
                                </a>
                            </li>
                        @endhasrole
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.calls.prefeituras') }}" class="nav-link">
                                <i class="fas fa-headset nav-icon text-slate-100"></i>
                                <p class="font-semibold text-slate-5    0 hover:text-yellow-400">Prefeituras</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.calls.governos') }}" class="nav-link">
                                <i class="fas fa-headset nav-icon text-slate-100"></i>
                                <p class="font-semibold text-slate-5    0 hover:text-yellow-400">Governo</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.calls.agendados') }}" class="nav-link">
                                <i class="fas fa-address-book nav-icon text-slate-100"></i>
                                <p class="font-semibold text-slate-5    0 hover:text-yellow-400">Agendados</p>
                            </a>
                        </li>
                    </ul>
                </li>
