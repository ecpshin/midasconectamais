                ...
                <form action="{{ route('admin.calls.store') }}" id="gov-update" class="mt-3" method="post">
                    ...
                    <div class="row">
                        <div class="col-lg-3 form-group mb-3">
                            <label class="text-xs font-semibold" for="mdata_ligacao">Ligação</label>
                            <input type="date" name="data_ligacao" id="mdata_ligacao"
                                class="w-100 mt-1 flex-1 rounded-lg border-gray-300 text-xs outline-none active:border-none active:ring-0">
                        </div>
                        <div class="col-lg-3 form-group mb-3">
                            <label class="text-xs font-semibold" for="magendado">Agendamento</label>
                            <input type="date" name="data_agendamento" id="mdata_agendamento"
                                class="w-100 mt-1 flex-1 rounded-lg border-gray-300 text-xs outline-none active:border-none active:ring-0">
                        </div>
                        <div class="col-lg-3 form-group mb-3">
                    ...
                    <div class="row">
                        <div class="col-lg-8 form-group mb-3">
                            <label class="text-xs font-semibold" for="mnome">Nome</label>
                        ...
                        <div class="col-lg-4 form-group mb-3">
                            ...
                            <input type="text" name="cpf" id="mcpf"
                    ...
                    <div class="row">
                        <div class="col-lg-3 form-group mb-3">
                            ...
                            <input type="text" name="matricula" id="mmatricula"
                                class="w-100 mt-1 flex-1 rounded-lg border-gray-300 text-xs outline-none active:border-none active:ring-0">
                        </div>
                        ...
                        <div class="form-group col-lg-3 mb-3">
                            ...
                            <input type="number" name="margem" id="mmargem" min="0" max="1000000" step="0.01"
