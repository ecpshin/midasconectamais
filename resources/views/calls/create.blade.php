                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-3 mb-3">
                                ...
                                <input type="number" name="margem" id="margem" min="0" max="1000000" step="0.01" 
                                       class="w-100 mt-1 flex-1 rounded-lg border-gray-300 text-xs outline-none active:border-none text-right active:outline-green-100 active:ring-0">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-12 form-group mb-3">
                                ...
                                <textarea name="observacoes" id="observacoes" rows="5"
                                          class="w-100 mt-1 flex-1 rounded-lg border-gray-300 text-xs outline-none active:border-none active:ring-0"></textarea>
                            </div>
                        </div>
