                            ...
                            @foreach ($comissoes ?? [] as $tax)
                                <tr class="odd:bg-fuchsia-100">
                                    ...
                                    <td class="text-xs font-semibold capitalize">
                                        {{ $tax->proposta->data_digitacao->format('d/m/y') }}
                                    </td>
                                    <td class="text-xs font-semibold capitalize">
                                        {{ $tax->proposta->data_pagamento->format('d/m/y') }}
                                    </td>
                                    <td class="text-xs font-semibold capitalize">
                                        {{ $tax->proposta->cliente->nome }}
                                    </td>
                                    <td class="text-xs font-semibold capitalize">
                                        {{ $tax->proposta->produto->descricao_produto }}
                                    </td>
                                    <td class="text-xs font-semibold capitalize">
                                    ...
                                    <td class="text-xs font-semibold capitalize">
                                        {{ $fmt->currency($tax->proposta->parcela_proposta, 'BRL', 'pt_BR') }}
                                    </td>
                                    <td class="text-xs font-semibold capitalize">
                                        {{ $fmt->percentage($tax->percentual_loja, 2) }}
                                    </td>
                                    <td class="text-xs font-semibold capitalize">
                                        {{ $fmt->currency($tax->valor_loja, 'BRL', 'pt_BR') }}
                                    </td>
                                    <td class="text-xs font-semibold capitalize">
                        ...
                        <table class="w-75 rounded-lg border">
                            ...
                            <tbody class="text-center text-sm font-semibold">
                                <tr>
                                    ...
                                    <td class="bg-yellow-500 p-2 font-bold text-slate-700">{{ $agente }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
